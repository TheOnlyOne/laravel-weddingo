    ...
    <div class="white-box p-0">
        ...
        <div class="page-aside">
            ...
            <div class="right-aside">
                <div class="right-page-header"><div class="pull-right"><input type="text" id="demo-input-search2" placeholder="search contacts" class="form-control"></div><h3>Contact / Employee List </h3>
                </div>
                ...
                <div class="scrollable">
                    <div class="table-responsive">
                        <table id="demo-foo-addrow" class="table m-t-30 table-hover contact-list" data-page-size="10">
                            ...
                            <tr>
                                <td>1</td>
                                <td><a href="contact-detail.html"><img src="{{ URL::asset('plugins/images/users/genu.jpg') }}" alt="user" class="img-circle"/> Genelia Deshmukh</a></td>
                            ...
                            <tr>
                                <td>2</td>
                                <td><a href="contact-detail.html"><img src="{{ URL::asset('plugins/images/users/arijit.jpg') }}" alt="user" class="img-circle"/> Arijit Singh</a></td>
                            ...
                            <tr>
                                <td>3</td>
                                <td><a href="contact-detail.html"><img src="{{ URL::asset('plugins/images/users/govinda.jpg') }}" alt="user" class="img-circle"/> Govinda jalan</a></td>
                            ...
                            <tr>
                                <td>4</td>
                                <td><a href="contact-detail.html"><img src="{{ URL::asset('plugins/images/users/hritik.jpg') }}" alt="user" class="img-circle"/> Hritik Roshan</a></td>
                            ...
                            <tr>
                                <td>5</td>
                                <td><a href="contact-detail.html"><img src="{{ URL::asset('plugins/images/users/john.jpg') }}" alt="user" class="img-circle"/> John Abraham</a></td>
                            ...
                            <tr>
                                <td>6</td>
                                <td><a href="contact-detail.html"><img src="{{ URL::asset('plugins/images/users/pawandeep.jpg') }}" alt="user" class="img-circle"/> Pawandeep kumar</a></td>
                            ...
                            <tr>
                                <td>7</td>
                                <td><a href="contact-detail.html"><img src="{{ URL::asset('plugins/images/users/ritesh.jpg') }}" alt="user" class="img-circle"/> Ritesh Deshmukh</a></td>
                            ...
                            <tr>
                                <td>8</td>
                                <td><a href="contact-detail.html"><img src="{{ URL::asset('plugins/images/users/salman.jpg') }}" alt="user" class="img-circle"/> Salman Khan</a></td>
                            ...
                            <tr>
                                <td>10</td>
                                <td><a href="contact-detail.html"><img src="{{ URL::asset('plugins/images/users/sonu.jpg') }}" alt="user" class="img-circle"/> Sonu Nigam</a></td>
                            ...
                            <tr>
                                <td>11</td>
                                <td><a href="contact-detail.html"><img src="{{ URL::asset('plugins/images/users/varun.jpg') }}" alt="user" class="img-circle"/> Varun Dhawan</a></td>
